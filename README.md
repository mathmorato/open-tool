...
[![Version](https://img.shields.io/badge/version-v.2.2.1-blue.svg)](package.json)
...
* **Controle SemVer:** O projeto segue o padrão [Semantic Versioning 2.0.0](https://semver.org/). A versão atual é **`v.2.2.1`**, sincronizada em todos os pontos de governança:
  1. Interface principal (`index.html`).
  2. Arquivo `package.json` (`"version": "2.2.1"`).
